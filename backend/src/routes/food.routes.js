...
router.post('/home',authMiddleware.authFoodPartnerMiddleware,upload.single("video"),foodController.createFood); //string ke andr jo video h wo aeve hi nhi diya blki jo frontend me uska naam h jese ki humne postman me uska video se naam save kiya h video ka to humx isme wahi daal skte h
...
router.get('/home',authMiddleware.authUserMiddleware,foodController.getFoodItems); 
